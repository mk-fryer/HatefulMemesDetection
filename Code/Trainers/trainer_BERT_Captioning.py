...
def train(text_model,text_model2, fusion_model,data_loader,test_loader,criterion,optimizer, lr_scheduler, modelpath, writer, device, epochs):
    ...
    for epoch in range(epochs):
        ...
        for batch_num, (feats, captions, input_ids, attention_masks, input_ids_cap, attention_masks_cap, target) in enumerate(data_loader):
            ...
            '''
            output_dictionary_captioning = text_model2(input_ids_cap,
                                           token_type_ids=None, 
            ...
            '''
            output = fusion_model(text_features, captioning_features)
...
#             lr_scheduler.step()
        ...
        valid_loss, top1_acc, _, _, _ = test_classify(text_model, text_model2, fusion_model, test_loader, criterion, device)
...
'''
def test_classify(text_model, text_model2, fusion_model, test_loader, criterion, device):
    fusion_model.eval()
    test_loss = []
    predicted_label = []
    prediction_probs = []
